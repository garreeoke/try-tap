...
install_tanzu_cli () {
  ...
  wget -O tanzu-cli-bundle-linux-amd64.tar --header="Authorization: Bearer $ACCESS_TOKEN" "https://network.pivotal.io/api/v2/products/build-service/releases/$3/product_files/$4/download"
